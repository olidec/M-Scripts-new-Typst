...
#block(
  ...
  *Permitted aids:* a CAS calculator. *No formula sheet* -- you are
  expected to know the standard definitions, forms, and identities. (The
  "Key results at a glance" section of the Review chapter is exactly the
  list to have at your fingertips.)
